            ...
            document.getElementById("output").innerHTML = ""; snapshot.forEach(function(childSnapshot) {
                   childKey  = childSnapshot.key;
                    childData = childSnapshot.val();
                        ...
                        name_with_tag = "<h4>" + name + "<img class='user_tick' src='https://lh3.googleusercontent.com/proxy/RE5PshSYNugekQPT56IWjFbzP3-tIahP3M-H3Hg8BG1mSAnx8Lb4GWLLfJ8konp-ZYaSzqpu-XIt-RzvifG87ZdZm6f2Oo0HvzoLtW0934sYQ0MkNO0'></h4>";
